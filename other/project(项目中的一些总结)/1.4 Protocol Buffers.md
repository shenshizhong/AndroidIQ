...
protoc --java_out=~/desktop/java ~/desktop/pr/*.proto

单个文件转换：
protoc -I=./pr --java_out=./java cmd.proto  

批量文件转换： 
protoc ./pr/*.proto --java_out=./java/.
输出到桌面的某个文件：
protoc ./pr/*.proto --java_out=/Users/ssz/Desktop/java/. 


protoc ./pr/*.proto --java_out=/Users/ssz/Desktop/java/. 
protoc ./workplace/myproto/*.proto  --java_out=./workplace/chanzai/app/src/main/pb_gen
```
